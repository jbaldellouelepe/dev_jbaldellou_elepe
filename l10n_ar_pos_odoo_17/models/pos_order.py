...
class PosOrder(models.Model):
    ...
    def _order_fields(self, ui_order):
        ...
        if order_args:
            ...
            self.env['account.fiscal.position']._get_fiscal_position(self.env['res.partner'].browse(ui_order['partner_id'])).id
...
class PosOrderLine(models.Model):
    ...
    def _compute_amount_line_all(self):
        self.ensure_one()
        fpos = self.order_id.fiscal_position_id or self.env['account.fiscal.position']._get_fiscal_position(self.order_id.partner_id)
